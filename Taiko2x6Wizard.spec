...
a = Analysis(
    ...
    binaries=[],
    datas=[],
    hiddenimports=['apa_merge', 'appconfig', 'apppaths', 'archive_builder', 'audioplayer', 'bineditor_enso_parts', 'bineditor_fname', 'bineditor_hdbdinfo', 'bineditor_lamp', 'bineditor_musicinfo', 'bineditor_rank', 'bineditor_streaminfo', 'bineditor_tuning', 'flipbook_player', 'gen3_convert', 'gen3_song', 'generators', 'hdbd', 'hdd_browser', 'hdd_song_wizard', 'img_slim', 'iso_packer', 'pfsshell_tool', 'ps2hdd', 'ps2mc_card', 'sht_validator', 'song_builder', 'song_manager', 'song_replacer', 'songtex', 'songtex_all', 'swg', 'swg_editor', 'taiko256_archive_tool_v2', 'taiko_exe', 'tim2', 'tja2sht', 'vagtool'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
